  ...
  es: {
    ...
    workItems: [
      ...
      },
      {
        ...
        solution: "Prototipo de catálogo visual enriquecido con metadatos de MusicBrainz, normalización automática mediante IA y cola de audio integrada para descubrimiento continuo.",
        techSystem: "MusicBrainz API / Audio Queue / AI Data Enrichment",
        label: "Ficha Lab ↗",
        viewCaseLabel: "Ver Caso ↗",
      },
    ] as CaseStudy[],
  ...
  en: {
    ...
    workItems: [
      ...
      },
      {
        ...
        solution: "Enriched visual catalogue prototype backed by MusicBrainz metadata, AI-assisted normalization, and a unified audio queue for continuous discovery.",
        techSystem: "MusicBrainz API / Audio Queue / AI Data Enrichment",
        label: "Lab File ↗",
        viewCaseLabel: "View Case ↗",
      },
